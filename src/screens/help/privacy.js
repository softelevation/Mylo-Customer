    ...
    <Block white>
      ...
      <Block padding={[heightPercentageToDP(1), widthPercentageToDP(3)]}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {renderBoldText('2. HOW DO WE USE YOUR INFORMATION?')}
          {renderBoldText(
          ...
          {renderBoldText(
            'To respond to legal requests and prevent harm. If we receive a subpoena or other legal request, we may need to inspect the data we hold to determine how to respond. Fulfill and manage your orders. We may use your information to fulfill and manage your orders, payments, returns, and exchanges made through the App.',
            false,
          )}
          {renderBoldText(
          ...
          {renderBoldText('3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?')}
          {renderBoldText(
          ...
          {renderBoldText('5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?')}
          {renderBoldText(
          ...
          {renderBoldText('6. HOW LONG DO WE KEEP YOUR INFORMATION?')}
          {renderBoldText(
          ...
          {renderBoldText('7. HOW DO WE KEEP YOUR INFORMATION SAFE?')}
          {renderBoldText(
          ...
          {renderBoldText('8. DO WE COLLECT INFORMATION FROM MINORS?')}
          {renderBoldText(
            'In Short:  We do not knowingly collect data from or market to children under 18 years of age.',
            false,
          )}
          {renderBoldText(
            'We do not knowingly solicit data from or market to children under 18 years of age. By using the App, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the App. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at info@mylopro.com.au.',
            false,
          )}
          {renderBoldText('9. WHAT ARE YOUR PRIVACY RIGHTS?')}
          {renderBoldText(
            'You may review, change, or terminate your account at any time.',
            false,
          )}
          {renderBoldText(
            'If you have questions or comments about your privacy rights, you may email us at info@mylopro.com.au',
            false,
          )}
          {renderBoldText('Account Information', false)}
          {renderBoldText(
          ...
          {renderBoldText(
            'Cookies and similar technologies: Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our App. ',
            false,
          )}
          {renderBoldText(
          ...
          {renderBoldText('10. CONTROLS FOR DO-NOT-TRACK FEATURES')}
          ...
          {renderBoldText('11. DO WE MAKE UPDATES TO THIS NOTICE?')}
          {renderBoldText(
          ...
          {renderBoldText('12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?')}
          {renderBoldText(
            'If you have questions or comments about this notice, you may email us at info@mylopro.com.au or by post to:',
            false,
          )}
          {renderBoldText('MyLo Pro', false)}
          {renderBoldText('Level 35, One International Towers,', false)}
          {renderBoldText('100 Barangaroo Ave,', false)}
          {renderBoldText('Sydney NSW 2000 Australia', false)}
          {renderBoldText(
            '13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?',
          )}
          {renderBoldText(
            'Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request by sending an email to info@mylopro.com.au.',
            false,
          )}
        </ScrollView>
      </Block>
